...
<body>
    <header class="text-black-900 body-font bg-blue-800">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row bg-white items-center fixed shadow-lg">
            ...
            <a class="mr-5 cursor-pointer" href="Notes.php">My Suggestion</a>
            <a class="mr-5 cursor-pointer" href="Blog.php">Blog</a>
            <a class="mr-5 cursor-pointer" href="Contact.php">Contact</a>
