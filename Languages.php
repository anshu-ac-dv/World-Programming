...
<body>
    ...
    <section class="text-gray-600 body-font">
        <div class="container px-14 py-0 mx-auto">
            ...
            <div class="p-4 md:w-1/3">
                <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden bg-white shadow-lg">
                <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="PHP.jpg" alt="blog">
                <div class="p-6">
                    <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">Free Course</h2>
            ...
            <div class="p-4 md:w-1/3">
                <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden bg-white shadow-lg">
                <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="SQL.jpg" alt="blog">
                <div class="p-6">
                    <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">Free Course</h2>
            ...
            <div class="p-4 md:w-1/3">
                <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden bg-white shadow-lg">
                <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="Python.png" alt="blog">
                <div class="p-6">
                    <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">Free Course</h2>
